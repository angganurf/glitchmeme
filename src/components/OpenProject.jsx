				...
				<div
					...
					style={
						openProjectExpand.expand
							? inlineStyleExpand("Internet")
							: inlineStyle("Internet")
					}
				>
					<div
						...
						style={{
							background: openProjectExpand.focusItem
								? themeDragBar
								: "#757579",
						}}
					>
						...
						<div className="folder_barbtn">
							...
							>
								<motion.div
									className={`expand ${openProjectExpand.expand ? "full" : ""}`}
								></motion.div>
								{openProjectExpand.expand ? (
					...
					<div
						...
						style={
							openProjectExpand.expand ? { height: "calc(100svh - 122px)" } : {}
						}
					>
