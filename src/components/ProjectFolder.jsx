		...
		>
			...
			>
				<div
					...
					style={{
						background: ProjectExpand.focusItem ? themeDragBar : "#757579",
					}}
				>
					...
					<div className="folder_barbtn-project">
						...
						<div>
							<p
								className="x-project"
								onClick={
									!isTouchDevice ? () => deleteTap("Project") : undefined
								}
					...
					<div className="object_bar-project">
						<p>
							{desktopIcon
								...
								? "1 object(s) selected"
								: `${
										desktopIcon.filter((icon) => icon.folderId === "Project")
											.length
								  } object(s)`}
						</p>
					</div>
							...
							{(() => {
								...
								return filteredIcons.every((icon) => !icon.focus)
									...
									: filteredIcons
											...
											.reduce((sum, icon) => sum + icon.size, 0);
							})()}{" "}
							KB
						</p>
					</div>
